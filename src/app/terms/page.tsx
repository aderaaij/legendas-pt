    ...
    <div className="min-h-screen py-12" style={{ background: 'var(--bg)', color: 'var(--text)' }}>
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="rounded-lg p-8" style={{ background: 'var(--surface)', border: '1px solid var(--border)' }}>
          <h1 className="text-3xl font-bold mb-6" style={{ color: 'var(--text)' }}>Terms of Service</h1>
          <p className="text-sm mb-8" style={{ color: 'var(--muted)' }}>Last updated: December 19, 2024</p>

          <div className="prose prose-invert max-w-none">
            <h2 className="text-2xl font-semibold mt-8 mb-4" style={{ color: 'var(--text)' }}>Agreement to Terms</h2>
            <p className="mb-4">
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4" style={{ color: 'var(--text)' }}>Description of Service</h2>
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4" style={{ color: 'var(--text)' }}>User Accounts</h2>
            
            <h3 className="text-xl font-semibold mt-6 mb-3" style={{ color: 'var(--text)' }}>Account Creation</h3>
            <ul className="list-disc pl-6 mb-4">
            ...
            <h3 className="text-xl font-semibold mt-6 mb-3" style={{ color: 'var(--text)' }}>Account Types</h3>
            <ul className="list-disc pl-6 mb-4">
            ...
            <h3 className="text-xl font-semibold mt-6 mb-3" style={{ color: 'var(--text)' }}>Account Termination</h3>
            <ul className="list-disc pl-6 mb-4">
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4" style={{ color: 'var(--text)' }}>Acceptable Use</h2>
            
            <h3 className="text-xl font-semibold mt-6 mb-3" style={{ color: 'var(--text)' }}>You May</h3>
            <ul className="list-disc pl-6 mb-4">
            ...
            <h3 className="text-xl font-semibold mt-6 mb-3" style={{ color: 'var(--text)' }}>You May Not</h3>
            <ul className="list-disc pl-6 mb-4">
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4" style={{ color: 'var(--text)' }}>Content and Intellectual Property</h2>
            
            <h3 className="text-xl font-semibold mt-6 mb-3" style={{ color: 'var(--text)' }}>User Content</h3>
            <ul className="list-disc pl-6 mb-4">
            ...
            <h3 className="text-xl font-semibold mt-6 mb-3" style={{ color: 'var(--text)' }}>Service Content</h3>
            <ul className="list-disc pl-6 mb-4">
            ...
            <h3 className="text-xl font-semibold mt-6 mb-3" style={{ color: 'var(--text)' }}>Copyright Compliance</h3>
            <ul className="list-disc pl-6 mb-4">
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4" style={{ color: 'var(--text)' }}>Learning Data and Progress</h2>
            
            <h3 className="text-xl font-semibold mt-6 mb-3" style={{ color: 'var(--text)' }}>Data Collection</h3>
            <ul className="list-disc pl-6 mb-4">
            ...
            <h3 className="text-xl font-semibold mt-6 mb-3" style={{ color: 'var(--text)' }}>Data Accuracy</h3>
            <ul className="list-disc pl-6 mb-4">
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4" style={{ color: 'var(--text)' }}>Service Availability</h2>
            
            <h3 className="text-xl font-semibold mt-6 mb-3" style={{ color: 'var(--text)' }}>Availability</h3>
            <ul className="list-disc pl-6 mb-4">
            ...
            <h3 className="text-xl font-semibold mt-6 mb-3" style={{ color: 'var(--text)' }}>Modifications</h3>
            <ul className="list-disc pl-6 mb-4">
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4" style={{ color: 'var(--text)' }}>Privacy and Data Protection</h2>
            <p className="mb-4">
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4" style={{ color: 'var(--text)' }}>Disclaimer of Warranties</h2>
            <p className="mb-4">
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4" style={{ color: 'var(--text)' }}>Limitation of Liability</h2>
            <p className="mb-4">
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4" style={{ color: 'var(--text)' }}>Indemnification</h2>
            <p className="mb-4">
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4" style={{ color: 'var(--text)' }}>Governing Law</h2>
            <p className="mb-4">
              These Terms are governed by the laws of [Your jurisdiction]. Any disputes will be resolved in the courts of [Your jurisdiction].
            </p>

            <h2 className="text-2xl font-semibold mt-8 mb-4" style={{ color: 'var(--text)' }}>Changes to Terms</h2>
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4" style={{ color: 'var(--text)' }}>Contact Information</h2>
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4" style={{ color: 'var(--text)' }}>Severability</h2>
            <p className="mb-4">
              If any provision of these Terms is found to be unenforceable, the remaining provisions will remain in full force and effect.
            </p>

            <h2 className="text-2xl font-semibold mt-8 mb-4" style={{ color: 'var(--text)' }}>Entire Agreement</h2>
            <p className="mb-4">
