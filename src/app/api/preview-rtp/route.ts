...
export async function POST(request: NextRequest) {
  try {
    ...
    // RTP lazy-loads episodes past the first page; scrapeSeries follows
    // RTP's own pagination cursor to fetch them all (no headless browser
    // needed) and resolves the season from the series title.
